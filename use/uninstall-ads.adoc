...
.步骤
. 登录到 https://mysupport.netapp.com/site/products/all/details/astra-data-store/downloads-tab["NetApp 支持站点"^] 并将Astra数据存储捆绑包(`Astra_Data_Store_2022.05.tar`)下载到可以访问Astra数据存储所在的Kubernetes集群的计算机上。
